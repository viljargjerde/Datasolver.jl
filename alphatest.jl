...
begin
	zero_alpha_results = Datasolver.DataDrivenNonlinearBar.directSolverNonLinearBar(
		node_vector,
		constrained_dofs,
		SE,
		costFunc_ele,
	...
	one_alpha_results = Datasolver.DataDrivenNonlinearBar.directSolverNonLinearBar(
		node_vector,
		constrained_dofs,
		SE,
		costFunc_ele,
