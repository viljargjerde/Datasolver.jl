...
# Test for calc_reldiff function
@testset "Utils calc_reldiff Function Tests" begin
	xs = [0.0, 0.5, 1.0]
	u_solved = [0.0, 0.25, 0.5]
	u_analytical = [0.0, 0.24, 0.48]

	rel_diff_1 = calc_reldiff(xs, u_solved, u_analytical)
	...
	rel_diff = calc_reldiff(xs, u_solved, u_analytical)
	@test rel_diff == 0.0
