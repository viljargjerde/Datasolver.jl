...
update_tex_command(all_results_file, "NLPFixedElementsPowerlawNull", format(FormatExpr("y \\propto x^{{{:.2f}}}"), b_null))
...
update_tex_command(all_results_file, "NLPFixedElementsPowerlawRand", format(FormatExpr("y \\propto x^{{{:.2f}}}"), b_rand))
