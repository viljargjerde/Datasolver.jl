...
begin
	...
	update_tex_command(all_results_file, "MINLPpowerlaw", format(FormatExpr("y = {}t^{{{:.2f}}}"), round(Int, a), b))
	update_tex_command(all_results_file, "MINLPMeanFinalTime", format(FormatExpr("y = {:.1f}"), t_final))
