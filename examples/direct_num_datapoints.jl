...
p = plot(scale = :log2, legend = :topleft, xlabel = "Data points", ylabel = "Median solve time (s)", palette = paired_colors) # :Paired_12 ,:tableau_20
plot!(table[1:end, "Datapoints"], table[1:end, "Nullspace initialization"], marker = :circle, label = "Nullspace initialization")
...
plot!(table[1:end, "Datapoints"], table[1:end, "Random initialization"], marker = :circle, label = "Random initialization")
