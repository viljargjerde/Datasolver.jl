...
# 	int_L(integrand) = int_L_(connections, Φ, integrand)
...
# 	# ]
# 	return [
# 		Z(m, m) Z(m, n) Z(m, n) int_NR(1 + Np * u) int_NN(R * s)
# 		Z(n, m) int_L(C) Z(n, n) -int_RR(1) Z(n, m)
# 		Z(n, m) Z(n, n) int_L(1 / C) Z(n, n) int_RN(1 + Np * u)
# 		int_RN(1 + 1 / 2 * u' * Np') -int_RR(1) Z(n, n) Z(n, n) Z(n, m)
# 		Z(m, m) Z(m, n) int_NR((1 + Np * u)') Z(m, n) Z(m, m)
# 	]
...
# 	@show int_NN(R * s)
# 	return [
# 		Z(m, m) Z(m, n) Z(m, n) int_NR(1 + Np * u) int_NN(R * (s) - 1)
# 		Z(n, m) int_L(C) Z(n, n) -int_RR(1) Z(n, m)
# 		Z(n, m) Z(n, n) int_L(1 / C) Z(n, n) int_RN(1 + Np * u)
# 		int_RN(1 + 1 / 2 * u' * Np') -int_RR(1) Z(n, n) Z(n, n) Z(n, m)
# 		Z(m, m) Z(m, n) int_NR((1 + Np * u)') Z(m, n) Z(m, m)
...
# 		Z(n, m) area*int_L(C) Z(n, n) int_RR(1)./Ls Z(n, m)
# 		Z(n, m) Z(n, n) area*int_L(1 / C) Z(n, n) int_RN(1 + Np * u)./Ls
# 		-int_RN(1 + 1 / 2 * u' * Np')./Ls int_RR(1)./Ls Z(n, n) Z(n, n) Z(n, m)
...
# 			Z(n, m)                    A*int_L(C)              Z(n, n)                  int_RR(1)./Ls       Z(n, m)
# 			int_RN(Np * λ)             Z(n, n)               A*int_L(1 / C)              Z(n, n)                   int_RN(1 + (Np * u)')./Ls
